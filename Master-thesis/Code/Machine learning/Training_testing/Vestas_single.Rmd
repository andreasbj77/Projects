...
```{r}
data_Vestas <- data %>% select(Date, Vestas)
```
...
tuner <- Hyperband(
  ...
  project_name = "Vestas_hyper_FNN_single")
```
...
tuner <- Hyperband(
  ...
  max_epochs = 10,
  hyperband_iterations = 5,
  project_name = "Vestas_hyper_RNN_single")
```
...
tuner <- Hyperband(
  ...
  max_epochs = 10,
  hyperband_iterations = 5,
  project_name = "Vestas_hyper_LSTM_single")
```
...
tuner <- Hyperband(
  ...
  max_epochs = 10,
  hyperband_iterations = 5,
  project_name = "Vestas_hyper_biLSTM_single")
```
...
tuner <- Hyperband(
  ...
  max_epochs = 10,
  hyperband_iterations = 5,
  project_name = "Vestas_hyper_GRU_single")
```
...
tuner <- Hyperband(
  ...
  max_epochs = 10,
  hyperband_iterations = 5,
  project_name = "Vestas_hyper_biGRU_single")
```
...
```{r}
save_model_hdf5(model_ANN, "model_ANN_Vestas_single")
save_model_hdf5(model_RNN, "model_RNN_Vestas_single")
save_model_hdf5(model_LSTM, "model_LSTM_Vestas_single")
save_model_hdf5(model_biLSTM, "model_biLSTM_Vestas_single")
save_model_hdf5(model_GRU, "model_GRU_Vestas_single")
save_model_hdf5(model_biGRU, "model_biGRU_Vestas_single")
Results %>% select(Model, RMSE, MAPE) %>% write.csv("Results_Vestas_single")
```
