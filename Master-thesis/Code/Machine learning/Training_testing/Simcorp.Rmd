...
tuner <- Hyperband(
  ...
  project_name = "SimCorp_hyper_FNN")
```
...
tuner <- Hyperband(
  ...
  max_epochs = 10,
  hyperband_iterations = 5,
  project_name = "SimCorp_hyper_RNN")
```
...
tuner <- Hyperband(
  ...
  max_epochs = 10,
  hyperband_iterations = 5,
  project_name = "SimCorp_hyper_LSTM")
```
...
tuner <- Hyperband(
  ...
  max_epochs = 10,
  hyperband_iterations = 5,
  project_name = "SimCorp_hyper_biLSTM")
```
...
tuner <- Hyperband(
  ...
  max_epochs = 10,
  hyperband_iterations = 5,
  project_name = "SimCorp_hyper_GRU")
```
...
tuner <- Hyperband(
  ...
  max_epochs = 10,
  hyperband_iterations = 5,
  project_name = "SimCorp_hyper_biGRU")
```
...
```{r}
save_model_hdf5(model_ANN, "model_ANN_SimCorp")
save_model_hdf5(model_RNN, "model_RNN_SimCorp")
save_model_hdf5(model_LSTM, "model_LSTM_SimCorp")
save_model_hdf5(model_biLSTM, "model_biLSTM_SimCorp")
save_model_hdf5(model_GRU, "model_GRU_SimCorp")
save_model_hdf5(model_biGRU, "model_biGRU_SimCorp")
Results %>% select(Model, RMSE, MAPE) %>% write.csv("Results_SimCorp")
```