...
tuner <- Hyperband(
  ...
  project_name = "JyskeBank_hyper_FNN")
```
...
tuner <- Hyperband(
  ...
  max_epochs = 10,
  hyperband_iterations = 5,
  project_name = "JyskeBank_hyper_RNN")
```
...
tuner <- Hyperband(
  ...
  max_epochs = 10,
  hyperband_iterations = 5,
  project_name = "JyskeBank_hyper_LSTM")
```
...
tuner <- Hyperband(
  ...
  max_epochs = 10,
  hyperband_iterations = 5,
  project_name = "JyskeBank_hyper_biLSTM")
```
...
tuner <- Hyperband(
  ...
  max_epochs = 10,
  hyperband_iterations = 5,
  project_name = "JyskeBank_hyper_GRU")
```
...
tuner <- Hyperband(
  ...
  max_epochs = 10,
  hyperband_iterations = 5,
  project_name = "JyskeBank_hyper_biGRU")
```
...
```{r}
save_model_hdf5(model_ANN, "model_ANN_JyskeBank")
save_model_hdf5(model_RNN, "model_RNN_JyskeBank")
save_model_hdf5(model_LSTM, "model_LSTM_JyskeBank")
save_model_hdf5(model_biLSTM, "model_biLSTM_JyskeBank")
save_model_hdf5(model_GRU, "model_GRU_JyskeBank")
save_model_hdf5(model_biGRU, "model_biGRU_JyskeBank")
Results %>% select(Model, RMSE, MAPE) %>% write.csv("Results_JyskeBank")
```
