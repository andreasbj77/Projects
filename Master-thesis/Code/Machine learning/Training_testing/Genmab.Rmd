...
data$Lundbeck %<>% scale(center = FALSE, scale = TRUE)
...
tuner <- Hyperband(
  ...
  max_epochs = 10,
  hyperband_iterations = 5,
  project_name = "Genmab_hyper_LSTM")
```
...
tuner <- Hyperband(
  ...
  max_epochs = 10,
  hyperband_iterations = 5,
  project_name = "Genmab_hyper_biLSTM")
```
...
tuner <- Hyperband(
  ...
  max_epochs = 10,
  hyperband_iterations = 5,
  project_name = "Genmab_hyper_biGRU")
```
...
```{r}
save_model_hdf5(model_ANN, "model_ANN_Genmab")
save_model_hdf5(model_RNN, "model_RNN_Genmab")
save_model_hdf5(model_LSTM, "model_LSTM_Genmab")
save_model_hdf5(model_biLSTM, "model_biLSTM_Genmab")
save_model_hdf5(model_GRU, "model_GRU_Genmab")
save_model_hdf5(model_biGRU, "model_biGRU_Genmab")
Results %>% select(Model, RMSE, MAPE) %>% write.csv("Results_Genmab")
```
