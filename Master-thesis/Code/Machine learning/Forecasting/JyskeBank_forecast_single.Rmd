...
```{r}
model_FNN <- load_model_hdf5("E:/Hyper_test/JyskeBank_single/model_ANN_JyskeBank_single")
model_RNN <- load_model_hdf5("E:/Hyper_test/JyskeBank_single/model_RNN_JyskeBank_single")
model_LSTM <- load_model_hdf5("E:/Hyper_test/JyskeBank_single/model_LSTM_JyskeBank_single")
model_biLSTM <- load_model_hdf5("E:/Hyper_test/JyskeBank_single/model_biLSTM_JyskeBank_single")
model_GRU <- load_model_hdf5("E:/Hyper_test/JyskeBank_single/model_GRU_JyskeBank_single")
model_biGRU <- load_model_hdf5("E:/Hyper_test/JyskeBank_single/model_biGRU_JyskeBank_single")
```
...
```{r}
Results %>% select(Model, RMSE, MAPE) %>% write.csv("forecast_JyskeBank_single")
```
