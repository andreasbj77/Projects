...
```{r}
model_FNN <- load_model_hdf5("E:/Hyper_test/Carlsberg/model_ANN_Carlsberg")
model_RNN <- load_model_hdf5("E:/Hyper_test/Carlsberg/model_RNN_Carlsberg")
model_LSTM <- load_model_hdf5("E:/Hyper_test/Carlsberg/model_LSTM_Carlsberg")
model_biLSTM <- load_model_hdf5("E:/Hyper_test/Carlsberg/model_biLSTM_Carlsberg")
model_GRU <- load_model_hdf5("E:/Hyper_test/Carlsberg/model_GRU_Carlsberg")
model_biGRU <- load_model_hdf5("E:/Hyper_test/Carlsberg/model_biGRU_Carlsberg")
```
...
```{r}
Results %>% select(Model, RMSE, MAPE) %>% write.csv("forecast_Carlsberg")
```
