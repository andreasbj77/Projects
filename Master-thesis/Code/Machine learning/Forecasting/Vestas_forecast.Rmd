...
```{r}
forecasting <- data_Vestas %>% filter(Date >= "2018-12-29")
```
...
```{r}
model_FNN <- load_model_hdf5("E:/Hyper_test/Vestas/model_ANN_Vestas")
model_RNN <- load_model_hdf5("E:/Hyper_test/Vestas/model_RNN_Vestas")
model_LSTM <- load_model_hdf5("E:/Hyper_test/Vestas/model_LSTM_Vestas")
model_GRU <- load_model_hdf5("E:/Hyper_test/Vestas/model_GRU_Vestas")
```
...
model_RNN <- load_model_hdf5("E:/Hyper_test/Vestas/model_RNN_Vestas")
model_LSTM <- load_model_hdf5("E:/Hyper_test/Vestas/model_LSTM_Vestas")
model_biLSTM <- load_model_hdf5("E:/Hyper_test/Vestas/model_biLSTM_Vestas")
model_GRU <- load_model_hdf5("E:/Hyper_test/Vestas/model_GRU_Vestas")
model_biGRU <- load_model_hdf5("E:/Hyper_test/Vestas/model_biGRU_Vestas")
```
...
```{r}
FNN_prediction_unscale <- FNN_prediction * att_Vestas
...
y_forecast_unscale <- y_forecast * att_Vestas
```
...
```{r}
Results %>% select(Model, RMSE, MAPE) %>% write.csv("forecast_Vestas")
```