...
```{r}
data_MaerskB <- data %>% select(Date, MaerskB)
```
...
```{r}
forecasting <- data_MaerskB %>% filter(Date >= "2018-12-29")
```
...
```{r}
model_FNN <- load_model_hdf5("E:/Hyper_test/MaerskB_single/model_ANN_MaerskB_single")
model_RNN <- load_model_hdf5("E:/Hyper_test/MaerskB_single/model_RNN_MaerskB_single")
model_LSTM <- load_model_hdf5("E:/Hyper_test/MaerskB_single/model_LSTM_MaerskB_single")
model_biLSTM <- load_model_hdf5("E:/Hyper_test/MaerskB_single/model_biLSTM_MaerskB_single")
model_GRU <- load_model_hdf5("E:/Hyper_test/MaerskB_single/model_GRU_MaerskB_single")
model_biGRU <- load_model_hdf5("E:/Hyper_test/MaerskB_single/model_biGRU_MaerskB_single")
```
...
```{r}
FNN_prediction_unscale <- FNN_prediction * att_MaerskB
...
y_forecast_unscale <- y_forecast * att_MaerskB
```
...
```{r}
Results %>% select(Model, RMSE, MAPE) %>% write.csv("forecast_MaerskB_single")
```
