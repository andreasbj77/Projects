...
```{r}
model_FNN <- load_model_hdf5("E:/Hyper_test/Genmab/model_ANN_Genmab")
model_RNN <- load_model_hdf5("E:/Hyper_test/Genmab/model_RNN_Genmab")
model_LSTM <- load_model_hdf5("E:/Hyper_test/Genmab/model_LSTM_Genmab")
model_biLSTM <- load_model_hdf5("E:/Hyper_test/Genmab/model_biLSTM_Genmab")
model_GRU <- load_model_hdf5("E:/Hyper_test/Genmab/model_GRU_Genmab")
model_biGRU <- load_model_hdf5("E:/Hyper_test/Genmab/model_biGRU_Genmab")
```
...
```{r}
Results %>% select(Model, RMSE, MAPE) %>% write.csv("forecast_Genmab")
```
