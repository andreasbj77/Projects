...
```{r}
model_FNN <- load_model_hdf5("E:/Hyper_test/MaerskB/model_ANN_MaerskB")
model_RNN <- load_model_hdf5("E:/Hyper_test/MaerskB/model_RNN_MaerskB")
model_LSTM <- load_model_hdf5("E:/Hyper_test/MaerskB/model_LSTM_MaerskB")
model_biLSTM <- load_model_hdf5("E:/Hyper_test/MaerskB/model_biLSTM_MaerskB")
model_GRU <- load_model_hdf5("E:/Hyper_test/MaerskB/model_GRU_MaerskB")
model_biGRU <- load_model_hdf5("E:/Hyper_test/MaerskB/model_biGRU_MaerskB")
```
...
```{r}
Results %>% select(Model, RMSE, MAPE) %>% write.csv("forecast_MaerskB")
```
