...
```{r}
model_FNN <- load_model_hdf5("E:/Hyper_test/Vestas_single/model_ANN_Vestas_single")
model_RNN <- load_model_hdf5("E:/Hyper_test/Vestas_single/model_RNN_Vestas_single")
model_LSTM <- load_model_hdf5("E:/Hyper_test/Vestas_single/model_LSTM_Vestas_single")
model_biLSTM <- load_model_hdf5("E:/Hyper_test/Vestas_single/model_biLSTM_Vestas_single")
model_GRU <- load_model_hdf5("E:/Hyper_test/Vestas_single/model_GRU_Vestas_single")
model_biGRU <- load_model_hdf5("E:/Hyper_test/Vestas_single/model_biGRU_Vestas_single")
```
...
```{r}
Results %>% select(Model, RMSE, MAPE) %>% write.csv("forecast_Vestas_single")
```
