...
```{r}
data <- read_csv("https://raw.githubusercontent.com/andreasbj77/Master-thesis/main/Data/Final_data/DataCreationCarlsberg.csv")
```
...
```{r}
forecasting <- data_Carlsberg %>% filter(Date >= "2018-12-29")
```
...
```{r}
model_FNN <- load_model_hdf5("E:/Hyper_test/Carlsberg_single/model_ANN_Carlsberg_single")
model_RNN <- load_model_hdf5("E:/Hyper_test/Carlsberg_single/model_RNN_Carlsberg_single")
model_LSTM <- load_model_hdf5("E:/Hyper_test/Carlsberg_single/model_LSTM_Carlsberg_single")
model_biLSTM <- load_model_hdf5("E:/Hyper_test/Carlsberg_single/model_biLSTM_Carlsberg_single")
model_GRU <- load_model_hdf5("E:/Hyper_test/Carlsberg_single/model_GRU_Carlsberg_single")
model_biGRU <- load_model_hdf5("E:/Hyper_test/Carlsberg_single/model_biGRU_Carlsberg_single")
```
...
```{r}
FNN_prediction_unscale <- FNN_prediction * att_Carlsberg
...
y_forecast_unscale <- y_forecast * att_Carlsberg
```
...
```{r}
Results %>% select(Model, RMSE, MAPE) %>% write.csv("forecast_Carlsberg_single")
```
