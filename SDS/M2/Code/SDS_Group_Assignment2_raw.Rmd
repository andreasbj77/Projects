...
```{r message=FALSE, warning=FALSE}
blacktwitter <- read_csv("https://raw.githubusercontent.com/andreasbj77/SDS/main/blacktwitter.csv")

bluetwitter <- read_csv("https://raw.githubusercontent.com/andreasbj77/SDS/main/bluetwitter.csv")
```
